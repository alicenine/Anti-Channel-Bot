...
check /help for more.""",
                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bots Channel", url=f"https://t.me/dodikiclub"),
                                                                 InlineKeyboardButton("Support Group", url=f"https://t.me/dodikiclub")]]),
...
for more help ask at @dodikiclub""",
                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bots Channel", url=f"https://t.me/dodikiclub"),
                                                                 InlineKeyboardButton("Support Group", url=f"https://t.me/dodikiclub")]]),
                             disable_web_page_preview=True)
